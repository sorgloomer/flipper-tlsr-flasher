...
*/
const uint32_t BitrateOptions__values[] = {10,     17,     30,     54,    96,    170,
                                           300,    540,    960,    1700,  3000,  5400,
                                           9600,   17000,  30000,  54000, 75000, 96000,
                                           170000, 300000, 540000, 960000};
const uint32_t BitrateOptions__count =
    sizeof(BitrateOptions__values) / sizeof(BitrateOptions__values[0]);
const uint32_t BitrateOptions__default = 75000;
